...
import { MessagePriority, MessageHandler, MessageCallback } from "../Core/Types"
...
export default class Message {
  ...
  public static subscribe(code: string, handler: MessageHandler): void {
    MessageSender.addSubscription(code, handler, undefined)
  }
  ...
  public static subscribeCallback(code: string, callback: MessageCallback): void {
    MessageSender.addSubscription(code, undefined, callback)
  }
  ...
  public static unsubscribe(code: string, handler: MessageHandler): void {
    MessageSender.removeSubscription(code, handler, undefined)
  }
  ...
  public static unsubscribeCallback(code: string, callback: MessageCallback): void {
    MessageSender.removeSubscription(code, undefined, callback)
  }
}